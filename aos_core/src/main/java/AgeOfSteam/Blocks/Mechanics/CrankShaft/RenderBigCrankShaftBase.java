...
public class RenderBigCrankShaftBase implements BlockEntityRenderer<EntityCrankShaftBase> {
    ...
    static {
        try {
            model = new WavefrontObject(ResourceLocation.fromNamespaceAndPath(Main.MODID, "objmodels/big_crankshaft.obj"));
        } catch (ModelFormatException ex) {
            throw new RuntimeException(ex);
        }
    }

    public RenderBigCrankShaftBase(BlockEntityRendererProvider.Context c, ResourceLocation texture) {
        super();
        this.tex = texture;
    }
