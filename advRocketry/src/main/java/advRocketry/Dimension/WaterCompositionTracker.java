    ...
    private static boolean shouldIgnoreCompositionChangeEvent() {
        ...
        return WALKER.walk(frames -> frames.anyMatch(frame ->
                frame.getDeclaringClass().equals(FlowingFluid.class) || // water spreading and source creation is skipped
                        ...
                        frame.getDeclaringClass().equals(DimensionEvents.class) || // this has a method to boil water and ice or freeze water, a reflection of change - ignore
                        frame.getDeclaringClass().equals(PlanetEvents.class) || // similar to dimension events, initial terraforming may place / replace ice and water blocks
