...
public class BlockEntities {
    ...
    public static final Supplier<BlockEntityType<EntityCo2Scrubber>> ENTITY_CO2_SCRUBBER = BLOCK_ENTITIES.register("co2_scrubber", () -> BlockEntityType.Builder.of(EntityCo2Scrubber::new, Blocks.CO2_SCRUBBER.get()).build(null));
