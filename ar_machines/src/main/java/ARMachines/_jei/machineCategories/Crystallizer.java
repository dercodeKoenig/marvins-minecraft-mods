...
public class Crystallizer extends MachineRecipeCategory {

    public static final RecipeType<MachineRecipe> MACHINE_RECIPE_TYPE = new RecipeType<>(
            ResourceLocation.fromNamespaceAndPath("armachines", "crystallizer"),
            MachineRecipe.class
    );
    ...
    public Component getTitle() {
        return Component.translatable("Crystallizer");
    }
